...
class ToolConfigFileTests(unittest.TestCase):
    def test_missing_evaluated_robot_axis_colliders_defaults_to_all_true(self):
        ...
        self.assertEqual([True, True, True, True, True, True], profile.evaluated_robot_axis_colliders)
