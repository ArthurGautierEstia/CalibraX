...
class RobotController(QObject):
    ...
    def __init__(self, robot_model: RobotModel, tool_model: ToolModel, robot_view: RobotView, parent: QObject = None):
        ...
        self.tool_controller = ToolController(self.tool_model, self.robot_view.get_configuration_widget())
