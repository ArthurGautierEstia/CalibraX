...
class ProgramController:
    ...
    def __init__(
        ...
        self.config_widget: TrajectoryConfigWidget = self.program_view.get_config_widget()
        ...
        self._configure_keypoint_widget()
    ...
    def _configure_keypoint_widget(self) -> None:
        ...
        self.config_widget.btn_import.hide()
        self.config_widget.btn_export.hide()
    ...
    def _setup_connections(self) -> None:
        ...
        self.actions_widget.display_options_changed.connect(self._refresh_display_only)
    ...
    def _selected_compensated_program(self) -> RobotProgram | None:
        if self.current_result is None:
            return None
        if self.actions_widget.selected_output_mode() == ProgramCompensationOutputMode.ARTICULAR:
    ...
    def _on_export_requested(self) -> None:
        ...
        suffix = "_compense_articulaire" if self.actions_widget.selected_output_mode() == ProgramCompensationOutputMode.ARTICULAR else "_compense_cartesien"
